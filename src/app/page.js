    ...
    <>
      <div className="container px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div className="col-6">
            <img src="https://midias.correio24horas.com.br/2024/02/21/edicasee-necessario-criar-novos-habitos-sustentaveis-para-salvar-o-planeta-imagem-nadun-prabodana--shutterstock-qxom3ll.jpg" className="d-block mx-lg-auto img-fluid" width="700" height="500" />
          </div>
          <div className="col-6">
